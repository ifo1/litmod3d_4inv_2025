...
!                                 h0 - h9 + 1, added to eliminate temporary solution model arrays 
      parameter (h4=5,h5=5,h6=10,h8=150,h9=30,h0=h9+1)
...
!                                 i11 - max number of dependent properties in a tab format file
      parameter (i6=2,i7=20,i8=40,i9=150,i10=200,i11=100)
...
!                                 j9  - max number of divariant assemblages
      parameter (j3=4,j4=5,j5=6,j6=8,j9=100)
...
! DEBUG691
      parameter(memory=200000,k31=2,k32=10,k33=1)
...
c----------------------------------------------------------------------
      parameter (k0=25,k2=50,k3=15,k4=32,k5=10)
      parameter (k7=k5+1,k8=k5+2,k17=8,k19=3*k5)
      parameter (k9=50,k10=100,k14=18,k15=6,k16=150)
...
!                                nsp - max number of species in fluid speciation routines 
      parameter (l2=5,l3=l2+2,l5=20,l6=100,l7=1,l8=10,l9=10,
     *           nsp=17,l10=nsp+l9+4)
